...
| :--: | ----------- | :--: | :---: | :-----------------------------: |
| [**Degrade**](Switches/Degrade.md "Wiki Page"){data-preview} | Disable toleration of `run0` as the command prefix; i.e., do not expand the *Sub-Command* if the *Initial Args* is prefixed with `run0` | `degrade` | `0` | ❌ |
