...
## Internal Operation
Because the last positional is always the sub-command, and the first positional is the string to replace with, the function simply returns two arguments it got with their positions swapped.
