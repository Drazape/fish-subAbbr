...
These functions are simply input/output converters; they parse the text inputted to them and generate a result which can be used as the replacement string.
